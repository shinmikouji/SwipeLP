    ...
    <section class="fv_wrap">
      ...
      <div class="slide_news">
        <div class="slider" id="slider" data-width="100">
          <button class="control_next" onclick="location.href='https://fukko.jp/newslists/'">&rarr;</button>
          <ul class="clearfix">
            <?php 
            $args = array(
              'post_type' => 'post',
                ...
                <div class="shadow">
                  <div class="teaser item">
                    <div class="text">
                      ...
                      <!-- <p class="name"><a href="<?php ?>"><?php the_title(); ?></a></p> -->
    ...
    <section class="geo">
      <div class="unit_in">
        <div class="h3_ttl">
          ...
          <p class="catch_ttl ef ef3_2">FUKKOとは本来もつ良さや想いを最大限広げる、<br>輝きや生きがいを取り戻す</p>
        ...
        <div class="cnt_in ef ef2_3">
          <div class="cnt">
            ...
            <div class="txt_in">
              <h4>WHO</h4>
              <p class="txt">適切なターゲットの<br>真のインサイトを理解</p>
            </div>
          </div><!-- end cnt -->
          <div class="cnt">
            ...
            <div class="txt_in">
              <h4>WHAT</h4>
              <p class="txt">選択される<br>本当の理由（価値）</p>
            </div>
          </div><!-- end cnt -->
          <div class="cnt">
            ...
            <div class="txt_in">
              <h4>WHERE</h4>
              <p class="txt">市場構造を味方し、<br>継続的で優位的な戦略を立案</p>
            </div>
          </div><!-- end cnt -->
          <div class="cnt">
            ...
            <div class="txt_in">
              <h4>HOW</h4>
              <p class="txt">最新のテクノロジーと<br>最適なアセット設定</p>
            </div>
          </div><!-- end cnt -->
        </div><!-- end cnt_in -->
      </div>
