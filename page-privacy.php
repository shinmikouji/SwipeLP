...
?>
    ...
    <main class="main__page__<?php echo $slug; ?> privacy">
      ...
      <section class="container">
        <section class="privacy list_item item">
          <section class="list_in">
            <h3 class="font01"><?php echo get_field('page__ttl'); ?></h3>
            <p class="sub_ttl"><?php echo get_field('page__sub-ttl'); ?></p>
            <div class="wrap clearfix">
              <!-- <div class="txt_in">
                FUKKOが提供するサービスのご案内です。<br>
                新サービスについてもこちらでご案内しております。
              </div> -->
            </div>
          </section>
          <div class="privacy_in">
            <p>株式会社FUKKO（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。</p>
            <h2>第1条（個人情報）</h2>
            ...
            <p>住所：〒171-0014 東京都豊島区池袋2丁目67-1 シティハウスノヴァ502<br>
              社名：株式会社FUKKO<br>
              Eメールアドレス：<a href="mailto:info@fukko.jp">info@fukko.jp</a>
            </p>
            <p class="tR">以上</p>
          </div>
