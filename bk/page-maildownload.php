      ...
      <section class="container">
        <section class="philosophy list_item item">
          <section class="list_in">
            ...
            <a id="nudgedownload" class="dlbtn" href="<?php echo get_template_directory_uri(); ?>/imges/service/nudge/ナッジマーケティング媒体資料.pdf" download="ナッジマーケティング媒体資料.pdf">ダウンロード</a>
          </section>
    ...
    setInterval(function() {
      if ($.cookie("downloaded")) {
        $.removeCookie("downloaded", {
          path: "http://fukko.local/service/nudge/download/thanks/"
        });
        alert("ダウンロード完了");
      }
    }, 1000);
