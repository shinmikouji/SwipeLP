      ...
      <section class="container">
        <section class="philosophy list_item item">
          <section class="list_in">
            ...
            <a id="nudgedownload" class="dlbtn" href="<?php echo get_template_directory_uri(); ?>/assets/img/msads/microsoft.pdf" download="マイクロソフト広告媒体資料.pdf" onclick="redirect()">ダウンロード</a>
